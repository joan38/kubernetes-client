...
lazy val bouncycastle = Agg(ivy"org.bouncycastle:bcpkix-jdk18on:1.82")

lazy val collectionCompat = Agg(ivy"org.scala-lang.modules::scala-collection-compat:2.14.0")

lazy val logging = Agg(ivy"org.typelevel::log4cats-slf4j:2.7.1")

lazy val logback = Agg(ivy"ch.qos.logback:logback-classic:1.5.20")

lazy val java8compat = Agg(ivy"org.scala-lang.modules::scala-java8-compat:1.0.2")

lazy val tests = Agg(ivy"org.scalameta::munit:1.2.1")
